...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/bisheng/webhook", controller.BishengNotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/bisheng/notify", controller.BishengNotify)
			userRoute.GET("/bisheng/notify", controller.BishengNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/bisheng/amount", controller.RequestBishengAmount)
				selfRoute.POST("/bisheng/pay", middleware.CriticalRateLimit(), controller.RequestBishengPay)
